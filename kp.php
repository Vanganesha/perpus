...
if($_SESSION[tipe]=='Dosen' or $_SESSION[tipe]=='Mahasiswa' OR $_SESSION[tipe]=='Admin'){
    $page = 'view_kp.vanray';
    $dataperpage = query("select b.tempat_KP as 'tempat', a.idbuku, a.nama, a.pengarang, c.nama as 'p1' ,b.abstrak from kp b left join buku a on a.idbuku=b.idbuku left join dosen c on b.pembimbing=c.iddosen where a.idkategori='3' order by a.idbuku DESC");
...
connect();
$bu=  query("select a.idbuku, a.nama, a.pengarang, c.nama as 'p1',b.tempat_KP as 'tempat' ,b.abstrak from kp b left join buku a on a.idbuku=b.idbuku left join dosen c on b.pembimbing=c.iddosen where a.idkategori='3' order by a.idbuku DESC limit $eu,$limit");
    ...
    <div id="scroll-wrap" class="container">
        <div class="main">
            ...
            <div id="bookshelf" class="bookshelf">
                 <?php 
                 if ($lala==0){
                     echo "<h2 class='text-center'>TIDAK ADA LAPORAN KERJA PRAKTEK DALAM DATABASE</h2>";
                 }else{
