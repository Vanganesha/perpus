...
if($_SESSION[tipe]=='Dosen' or $_SESSION[tipe]=='Mahasiswa' OR $_SESSION[tipe]=='Admin'){
    $page = 'view_pp.vanray';
    $dataperpage = query("select a.idbuku, a.nama, a.pengarang, c.nama as 'p1',b.abstrak from pp b left join buku a on a.idbuku=b.idbuku left join dosen c on b.pembimbing=c.iddosen where a.idkategori='4' order by a.idbuku DESC");
...
connect();
$bu=  query("select a.idbuku, a.nama, a.pengarang, c.nama as 'p1',b.abstrak from pp b left join buku a on a.idbuku=b.idbuku left join dosen c on b.pembimbing=c.iddosen where a.idkategori='4' order by a.idbuku DESC limit $eu,$limit");
